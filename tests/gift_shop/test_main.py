...
class TestProductID(TestCase):
    ...
    def test_is_repeating_for_single_digit_odd_digits(self) -> None:
        self.assertFalse(ProductID(22222).is_repeating)
...
class TestProductIDRange(TestCase):
    ...
    def test_repeating_product_ids_at_range_terminals(self) -> None:
        product_range = [int(id_) for id_ in ProductIDRange(start=ProductID(11), end=ProductID(22)).repeating_numbers_from_range]
    ...
    def test_one_repeating_product_ids_in_range(self) -> None:
        ...
        product_range = [int(id_) for id_ in ProductIDRange(start=start, end=end).repeating_numbers_from_range]
